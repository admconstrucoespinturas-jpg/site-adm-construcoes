...
const TESTIMONIALS = [
  { name: 'Levi',          city: 'Avaliação no Google', stars: 5, text: 'Muito bom o trabalho, profissionalismo em primeiro lugar' },
  { name: 'Ellen Fidelis', city: 'Avaliação no Google', stars: 5, text: 'Ótimo trabalho, de qualidade e super confiável' },
  { name: 'Gisele Maria',  city: 'Avaliação no Google', stars: 5, text: 'Excelente' },
]
